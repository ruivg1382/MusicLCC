...
require_once('header.php');
 ...
 $stmt=$conn->prepare("SELECT * FROM musica WHERE genero='outros' order by id_musica desc");
 ...
 foreach($result as $row) {?>
 	...
 	<div class="container">	
 		...
 		<div class="row my-3">	
 			...
 			<div class="col-md-6 col-sm-12 my-3 py-3 card border shadow-lg p-3 mb-5 bg-white rounded-pill">
