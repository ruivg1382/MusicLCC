    ...
    <div class="col-md-6 col-sm-6 my-3">
     <form action="musica_search.php">
       <div class="input-group mb-3">
          ...
          <input class="btn btn-primary" type="submit" id="button-addon2" value="pesquisar">
      </div>
     </form>
    ...
    <div class="col-md-3 col-sm-3"></div>
        ...
        <div class="row">  
            ...
            <?php
                ...
                $stmt=$conn->prepare("SELECT * FROM musica  order by id_musica desc");
